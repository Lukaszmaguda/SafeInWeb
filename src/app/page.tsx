				...
				<div className="container px-4 md:px-6 mx-auto">
					<div className="flex flex-col items-center gap-6 text-center">
						...
						<p className="max-w-[900px] text-lg text-muted-foreground md:text-xl">
							Dowiedz się jak chronić siebie i swoich bliskich
							przed zagrożeniami w internecie. Zdobądź praktyczną
							wiedzę poprzez interaktywne quizy i materiały
							edukacyjne.
						</p>
				...
				<div className="container px-4 md:px-6 mx-auto">
					<div className="flex flex-col items-center justify-center gap-6 text-center">
						...
						<p className="max-w-[800px] text-lg text-muted-foreground md:text-xl">
							Poznaj najważniejsze aspekty bezpieczeństwa w sieci
							i naucz się chronić swoje dane.
						</p>
					</div>
			...
			<section className="w-full py-12 md:py-8 lg:py-8 bg-muted">
				<div className="container px-4 md:px-6 mx-auto">
					<div className="flex flex-col items-center gap-6 text-center">
						...
						<p className="max-w-[800px] text-lg text-muted-foreground md:text-xl">
							Dołącz do nas i zacznij swoją podróż ku bezpiecznemu
				...
				<div className="container px-4 md:px-6 mx-auto">
					<div className="flex flex-col items-center justify-center gap-4 text-center">
						<p className="text-base text-muted-foreground">
							© {new Date().getFullYear()} Safer in Web - Łukasz
							Maguda. Wszystkie prawa zastrzeżone.
						</p>
					</div>
				</div>
			</footer>
