...
export default async function QuizyPage() {
	...
	const quizy = [
		...
		},
		{
			...
			description:
				"Dowiedz się jak tworzyć silne hasła i chronić swoje konta.",
			difficulty: "Średni",
			time: "15 min",
			questionsCount: 12,
		},
		...
		{
			id: "dzieci",
			title: "Ochrona dzieci w sieci",
			description:
				"Jak zadbać o bezpieczeństwo najmłodszych użytkowników internetu.",
			difficulty: "Średni",
			time: "15 min",
			questionsCount: 10,
		},
		{
			...
			description:
				"Jak chronić swoje dane osobowe i prywatność w internecie.",
			difficulty: "Trudny",
			time: "20 min",
			questionsCount: 15,
		},
		...
		<div className="container mx-auto px-4 py-12">
			<div className="flex flex-col items-center gap-6 text-center mb-12">
				...
				<p className="max-w-[800px] text-lg text-muted-foreground">
					Sprawdź swoją wiedzę i naucz się nowych rzeczy poprzez
					interaktywne quizy. Każdy quiz zawiera pytania z różnych
					obszarów bezpieczeństwa w internecie.
				</p>

				<SignedOut>
					<div className="mt-4 p-6 bg-muted rounded-lg">
						<p className="mb-4 font-medium">
							Zaloguj się, aby zapisywać swoje wyniki i śledzić
							postępy.
						</p>
